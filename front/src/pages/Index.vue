                    ...
                    <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                        <div class="pr-12">
                            ...
                            <p class="mt-4 text-lg text-gray-300">
                                Need a page for 3 languages? Spanish, English and German? Here you are home. Lorem to the ipsum! Bla Bla Bla!
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container mx-auto px-4">
                    ...
                    <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Spanish</h6>
                    ...
                    <div class="w-full md:w-4/12 px-4 text-center">
                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">English</h6>
                                <p class="mt-2 mb-4 text-gray-600">
                    ...
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">German</h6>
                                <p class="mt-2 mb-4 text-gray-600">
                ...
                <div class="flex flex-wrap items-center mt-32">
                    ...
                    <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-teal-600">
                            ...
                            <blockquote class="relative p-8 mb-4">
                                <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" class="absolute left-0 w-full block" style="height: 95px; top: -94px;">
                                    <polygon points="-30,95 583,95 583,65" class="text-teal-600 fill-current"></polygon>
                                </svg>
            ...
            <div class="container mx-auto px-4">
                <div class="items-center flex flex-wrap">
                    ...
                    <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div class="md:pr-12">
                            <div class="text-pink-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-teal-200">
                                <i class="fas fa-rocket text-xl"></i>
                            </div>
                            <h3 class="text-3xl font-semibold">About Me</h3>
                            <h6 class="text-s text-teal-600">Miguel Rodriguez Hochhaltinger</h6>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap justify-center text-center mb-24">
                    <div class="w-full lg:w-6/12 px-4">
                        <h2 class="text-4xl font-semibold">My Tech Stack</h2>
                        <p class="text-lg leading-relaxed text-gray-600">
                            I will show you the benefits of having a headless cms. The decoupled nature of your content and the Front End designs are enourmes.
                            You can change your content easily and whenever you want with Strapi, while not touching anything of the design.
                        </p>
                    </div>
                </div>
                <div class="flex flex-wrap">
                    <div class="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            ...
                            <div class="pt-6 text-center">
                                <h5 class="text-xl font-bold">TailwindCSS</h5>
                    ...
                    <div class="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            ...
                            <div class="pt-6 text-center">
                                <h5 class="text-xl font-bold">Gridsome</h5>
                                <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
                                    Logic
                                </p>
                                <div class="mt-6">
                    ...
                    <div class="w-full md:w-6/12 lg:w-4/12 lg:mb-0 mb-12 px-4">
                        <div class="px-6">
                            ...
                            <div class="pt-6 text-center">
                                <h5 class="text-xl font-bold">Strapi</h5>
                                <p class="mt-1 text-sm text-gray-500 uppercase font-semibold">
                                    Headless CMS
                                </p>
                                <div class="mt-6">
